...
switch_voice = os.environ.get('FEATURE_TRANSCRIPTION')
switch_ocr = os.environ.get('FEATURE_IMAGE_READ')
switch_docs = os.environ.get('FEATURE_DOCUMENT_READ')
switch_imgs = os.environ.get('FEATURE_IMAGE_GENERATION')
switch_urls = os.environ.get('FEATURE_URL_READ')
