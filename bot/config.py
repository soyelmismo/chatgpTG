...
timeout_ask = bool(os.environ.get('TIMEOUT_ASK'))
switch_voice = bool(os.environ.get('FEATURE_TRANSCRIPTION'))
switch_ocr = bool(os.environ.get('FEATURE_IMAGE_READ'))
switch_docs = bool(os.environ.get('FEATURE_DOCUMENT_READ'))
switch_imgs = bool(os.environ.get('FEATURE_IMAGE_GENERATION'))
switch_urls = bool(os.environ.get('FEATURE_URL_READ'))
